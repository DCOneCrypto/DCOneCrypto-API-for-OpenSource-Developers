...
namespace DCOneCrypto.Api.Controllers
{
    ...
    public class AssetController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<string>> GetAssetAddresses(string _asset_policy, string _asset_name)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<string>> GetAssetNFTAddress(string _asset_policy, string _asset_name)
        {
        ...
        [Route("asset_info")]
        [HttpGet]
        public async Task<ActionResult<string>> GetAssetInfo(string _asset_policy, string _asset_name)
        {
        ...
        [Route("asset_history")]
        [HttpGet]
        public async Task<ActionResult<string>> GetAssetHistory(string _asset_policy, string _asset_name)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<string>> GetPolicyAssetAddresses(string _asset_policy)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<string>> GetPolicyAssetInfo(string _asset_policy)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<string>> GetPolicyAssetList(string _asset_policy)
        {
        ...
        [Route("asset_summary")]
        [HttpGet]
        public async Task<ActionResult<string>> GetAssetSumary(string _asset_policy, string _asset_name)
        {
        ...
        [Route("asset_txs")]
        [HttpGet]
        public async Task<ActionResult<string>> GetAssetTransactions(string _asset_policy, string _asset_name, int _after_block_height, bool _history)
        {
